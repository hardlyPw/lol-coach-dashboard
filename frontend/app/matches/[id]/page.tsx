...
export default function MatchDetailPage() {
    ...
    useEffect(() => {
        ...
        const fetchGameData = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`http://3.34.82.181:8080/api/matches/${currentMatchId}`);
    ...
    useEffect(() => {
        ...
        const fetchMetrics = async () => {
            ...
            try {
                const res = await axios.get(`http://3.34.82.181:8080/api/matches/${currentMatchId}/metrics`, {
    ...
    useEffect(() => {
        ...
        const fetchRangeAnalysis = async () => {
            ...
            try {
                const res = await axios.get(`http://3.34.82.181:8080/api/matches/${currentMatchId}/analysis`, {
                    params: {
                        start: startSec,
                        end: endSec,
                        sourceDa: s,
